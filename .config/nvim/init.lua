...
-- SET COLORS FOR TMUX + Alacritty + Nvim TO WORK: https://gist.github.com/andersevenrud/015e61af2fd264371032763d4ed965b6
...
vim.keymap.set('i', '<C-BS>', '<C-w>', { silent = true, desc = 'Delete word before curosr' })
-- Ctrl + Delete to delete the word after the cursor in insert mode
vim.keymap.set('i', '<C-Del>', '<C-o>dw', { silent = true, desc = 'Delete word after cursor' })
      ...
      local servers = {
        clangd = {
          ...
          capabilities = {
            ...
            offsetEncoding = { 'utf-16' }, -- this fixes the issue with clangd not showing diagnostics while typing
          },
        },
        gopls = {},
        pyright = {},
